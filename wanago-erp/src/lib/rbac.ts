...
export const PAGE_ACCESS: PageAccess = {
  super_admin: ["*"],
  admin:       ["*"],
  operations:  ["dashboard", "ess", "team-pulse", "forms", "leads", "customers", "bookings", "operations", "packages", "suppliers", "itineraries", "itinerary-brochures", "ops-approvals", "reviews", "resources", "vendor-rates", "settings"],
...
export const PAGE_LABELS: Record<string, string> = {
  ...
  "vendor-rates": "Vendor Rates & Availability",
