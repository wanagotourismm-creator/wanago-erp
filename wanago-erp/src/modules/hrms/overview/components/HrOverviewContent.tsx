...
import type { EmployeeToday, DepartmentSummary } from "@/modules/hrms/overview/hooks/useHrOverview";
...
export function HrKpiOverview({ headcount, attendancePct, onLeaveToday, absentToday, unmarkedToday, awaitingApproval, departmentSummaries }: KpiProps) {
  const tiles = [
...
export function HrTodayAttendanceList({ employeesToday }: { employeesToday: EmployeeToday[] }) {
  return (
    <div className="fluid-card rounded-2xl border border-border bg-card p-5 shadow-sm">
