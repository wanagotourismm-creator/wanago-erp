    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {items.map(({ module, totalSteps, completedCount, percent, isComplete, started }) => (
            <div key={module.id} className="flex flex-col rounded-2xl border border-border bg-card p-5 shadow-sm">
              ...
              <button
                ...
                disabled={totalSteps === 0 || (starting && startingId === module.id)}
                ...
                {isComplete ? "Review Again" : started ? "Continue" : "Start Training"}
              </button>
            </div>
          ))}
        </div>
