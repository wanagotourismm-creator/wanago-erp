  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] flex-col bg-card lg:min-h-[calc(100vh-64px)]">
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <nav data-tour-id="tour-hrshell-nav" className="flex flex-shrink-0 gap-4 overflow-x-auto border-b border-border bg-muted/20 p-3 lg:sticky lg:top-0 lg:max-h-[calc(100vh-64px)] lg:w-56 lg:flex-col lg:gap-5 lg:self-start lg:overflow-x-visible lg:overflow-y-auto lg:border-b-0 lg:border-r scrollbar-thin">
          {navGroups.map((group) => (
